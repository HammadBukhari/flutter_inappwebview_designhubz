...
import 'package:flutter_inappwebview_designhubz_example/chrome_safari_browser_example.screen.dart';
import 'package:flutter_inappwebview_designhubz_example/headless_in_app_webview.screen.dart';
import 'package:flutter_inappwebview_designhubz_example/in_app_webiew_example.screen.dart';
import 'package:flutter_inappwebview_designhubz_example/in_app_browser_example.screen.dart';
import 'package:flutter_inappwebview_designhubz_example/web_authentication_session_example.screen.dart';
  ...
  return PointerInterceptor(
    child: Drawer(
      child: ListView(
        ...
        children: <Widget>[
          DrawerHeader(
            child: Text('flutter_inappwebview_designhubz example'),
