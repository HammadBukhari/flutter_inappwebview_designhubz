...
///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager}
class CookieManager {
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager}
  CookieManager()
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.setCookie}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.getCookies}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.getCookie}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.deleteCookie}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.deleteCookies}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.deleteAllCookies}
  Future<bool> deleteAllCookies() => platform.deleteAllCookies();

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.getAllCookies}
  Future<List<Cookie>> getAllCookies() => platform.getAllCookies();

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformCookieManager.removeSessionCookies}
