...
///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase}
class HttpAuthCredentialDatabase {
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase.getAllAuthCredentials}
  Future<List<URLProtectionSpaceHttpAuthCredentials>> getAllAuthCredentials() =>
      platform.getAllAuthCredentials();

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase.getHttpAuthCredentials}
  Future<List<URLCredential>> getHttpAuthCredentials(
          {required URLProtectionSpace protectionSpace}) =>
      platform.getHttpAuthCredentials(protectionSpace: protectionSpace);

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase.setHttpAuthCredential}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase.removeHttpAuthCredential}
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase.removeHttpAuthCredentials}
  Future<void> removeHttpAuthCredentials(
          {required URLProtectionSpace protectionSpace}) =>
      platform.removeHttpAuthCredentials(protectionSpace: protectionSpace);

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformHttpAuthCredentialDatabase.clearAllAuthCredentials}
