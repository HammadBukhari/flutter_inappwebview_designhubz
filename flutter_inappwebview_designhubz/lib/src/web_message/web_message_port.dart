...
///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformWebMessagePort}
class WebMessagePort implements IWebMessagePort {
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformWebMessagePort.setWebMessageCallback}
  Future<void> setWebMessageCallback(WebMessageCallback? onMessage) =>
      platform.setWebMessageCallback(onMessage);

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformWebMessagePort.postMessage}
  Future<void> postMessage(WebMessage message) => platform.postMessage(message);

  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformWebMessagePort.close}
