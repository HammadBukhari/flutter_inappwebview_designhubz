package com.pichillilorenzo.flutter_inappwebview_designhubz_android.plugin_scripts_js;

import com.pichillilorenzo.flutter_inappwebview_designhubz_android.types.PluginScript;
import com.pichillilorenzo.flutter_inappwebview_designhubz_android.types.UserScriptInjectionTime;
...
public class InterceptAjaxRequestJS {
  ...
  public static final String INTERCEPT_AJAX_REQUEST_JS_SOURCE = "(function(ajax) {" +
          ...
          "  ajax.prototype._flutter_inappwebview_designhubz_url = null;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_method = null;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_isAsync = null;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_user = null;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_password = null;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_password = null;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_already_onreadystatechange_wrapped = false;" +
          "  ajax.prototype._flutter_inappwebview_designhubz_request_headers = {};" +
          ...
          "    this._flutter_inappwebview_designhubz_url = url;" +
          "    this._flutter_inappwebview_designhubz_method = method;" +
          "    this._flutter_inappwebview_designhubz_isAsync = isAsync;" +
          "    this._flutter_inappwebview_designhubz_user = user;" +
          "    this._flutter_inappwebview_designhubz_password = password;" +
          "    this._flutter_inappwebview_designhubz_request_headers = {};" +
          "    open.call(this, method, url, isAsync, user, password);" +
          "  };" +
          "  ajax.prototype.setRequestHeader = function(header, value) {" +
          "    this._flutter_inappwebview_designhubz_request_headers[header] = value;" +
          ...
          "        var ajaxRequest = {" +
          "          method: self._flutter_inappwebview_designhubz_method," +
          "          url: self._flutter_inappwebview_designhubz_url," +
          "          isAsync: self._flutter_inappwebview_designhubz_isAsync," +
          "          user: self._flutter_inappwebview_designhubz_user," +
          "          password: self._flutter_inappwebview_designhubz_password," +
          "          withCredentials: self.withCredentials," +
          "          headers: self._flutter_inappwebview_designhubz_request_headers," +
          ...
          "    var self = this;" +
          "    var w = (window.top == null || window.top === window) ? window : window.top;" +
          "    var canBeIntercepted = self._flutter_inappwebview_designhubz_isAsync || w." + FLAG_VARIABLE_FOR_INTERCEPT_ONLY_ASYNC_AJAX_REQUESTS_JS_SOURCE + " === false;" +
          ...
          "      if (!this._flutter_inappwebview_designhubz_already_onreadystatechange_wrapped) {" +
          "        this._flutter_inappwebview_designhubz_already_onreadystatechange_wrapped = true;" +
          ...
          "            if (result.responseType != null && self._flutter_inappwebview_designhubz_isAsync) {" +
          "              self.responseType = result.responseType;" +
          "            };" +
          "            for (var header in result.headers) {" +
          "              var value = result.headers[header];" +
          "              var flutter_inappwebview_designhubz_value = self._flutter_inappwebview_designhubz_request_headers[header];" +
          "              if (flutter_inappwebview_designhubz_value == null) {" +
          "                self._flutter_inappwebview_designhubz_request_headers[header] = value;" +
          "              } else {" +
          "                self._flutter_inappwebview_designhubz_request_headers[header] += ', ' + value;" +
          "              }" +
          "              setRequestHeader.call(self, header, value);" +
          "            };" +
          "            if ((self._flutter_inappwebview_designhubz_method != result.method && result.method != null) ||" +
          "                (self._flutter_inappwebview_designhubz_url != result.url && result.url != null) ||" +
          "                (self._flutter_inappwebview_designhubz_isAsync != result.isAsync && result.isAsync != null) ||" +
          "                (self._flutter_inappwebview_designhubz_user != result.user && result.user != null) ||" +
          "                (self._flutter_inappwebview_designhubz_password != result.password && result.password != null)) {" +
          "              self.abort();" +
