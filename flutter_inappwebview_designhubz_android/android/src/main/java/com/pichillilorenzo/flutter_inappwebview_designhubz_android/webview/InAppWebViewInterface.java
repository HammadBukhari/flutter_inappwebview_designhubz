...
public interface InAppWebViewInterface {
  ...
  void postWebMessage(com.pichillilorenzo.flutter_inappwebview_designhubz_android.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
