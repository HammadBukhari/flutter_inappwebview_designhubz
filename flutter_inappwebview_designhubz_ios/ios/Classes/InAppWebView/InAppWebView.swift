...
public class InAppWebView: WKWebView, UIScrollViewDelegate, WKUIDelegate,
                            ...
                            Disposable {
    static let METHOD_CHANNEL_NAME_PREFIX = "com.pichillilorenzo/flutter_inappwebview_designhubz_"
    ...
    public override func hitTest(_ point: CGPoint, with event: UIEvent?) -> UIView? {
        ...
        // https://github.com/pichillilorenzo/flutter_inappwebview_designhubz/pull/1665
    ...
    public func webView(_ webView: WKWebView, didReceive challenge: URLAuthenticationChallenge, completionHandler: @escaping (URLSession.AuthChallengeDisposition, URLCredential?) -> Void) {
        ...
        if challenge.protectionSpace.authenticationMethod == NSURLAuthenticationMethodHTTPBasic ||
            ...
            if let scheme = challenge.protectionSpace.protocol, scheme == "https" {
                ...
                // https://github.com/pichillilorenzo/flutter_inappwebview_designhubz/issues/1678
                ...
                if let action = response.action {
                    ...
                    switch action {
                        case 0:
                            ...
                            break
                        case 1:
                            // workaround for https://github.com/pichillilorenzo/flutter_inappwebview_designhubz/issues/1924
                            DispatchQueue.global(qos: .background).async {
