...
class IOSWebMessageListener extends PlatformWebMessageListener
  ...
  IOSWebMessageListener(PlatformWebMessageListenerCreationParams params)
    ...
    channel = MethodChannel(
        'com.pichillilorenzo/flutter_inappwebview_designhubz_web_message_listener_${_id}_${params.jsObjectName}');
...
///{@macro flutter_inappwebview_designhubz_platform_interface.JavaScriptReplyProxy}
