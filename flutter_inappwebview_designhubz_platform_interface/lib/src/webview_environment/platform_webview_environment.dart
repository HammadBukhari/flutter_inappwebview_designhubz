...
class PlatformWebViewEnvironmentCreationParams {
  ...
  ///{@macro flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.settings}
...
abstract class PlatformWebViewEnvironment extends PlatformInterface
  ...
  ///{@template flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.id}
  /// WebView Environment ID.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.settings}
  /// WebView Environment settings.
  ///{@endtemplate}
  WebViewEnvironmentSettings? get settings => params.settings;

  ///{@template flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.create}
  ...
  ///{@template flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.getAvailableVersion}
  ...
  ///{@template flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.compareBrowserVersions}
  ...
  ///{@template flutter_inappwebview_designhubz_platform_interface.PlatformWebViewEnvironment.dispose}
